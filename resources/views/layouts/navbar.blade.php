...
@vite('resources/js/navbar-burger.js')
    <nav class="relative px-4 py-4 flex justify-between items-center bg-white sticky top-0 z-10">
		...
		<a class="hidden lg:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 text-sm text-white font-bold rounded-xl transition duration-200" href="/register">Register</a>
	</nav>
	<div class="navbar-menu relative z-50 hidden">
		...
		<nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
			...
			<div class="mt-auto">
				<div class="pt-6">
					<a class="block px-4 py-3 mb-3  text-xs text-center font-semibold leading-none bg-gray-50 hover:bg-gray-100 rounded-xl" href="/login">Login</a>
					<a class="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-blue-600 hover:bg-blue-700  rounded-xl" href="/register">Register</a>
				</div>
				<p class="my-4 text-xs text-center text-gray-400">
					<span>Copyright © 2021 Afwan Gibran Muhammad Algiffari</span>
				</p>
			</div>
		</nav>
	</div>
