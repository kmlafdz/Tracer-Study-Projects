        ...
        <div class="p-8 rounded-lg max-w-md w-full fade-in" id="login-form">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="flex flex-wrap justify-center">
                    <button type="button"
                        class="text-white font-semibold py-2 px-4 rounded-lg hover:bg-opacity-75 transition duration-300 flex-1 min-w-[120px] mx-2"><a href="/register">Register</a></button>
                    <button type="submit"
                        class="bg-white text-blue-600 font-semibold py-2 px-4 rounded-full hover:bg-opacity-75 transition duration-300 flex-1 min-w-[120px] mx-2">Login</button>
                </div>
            </form>
        </div>
    </div>
